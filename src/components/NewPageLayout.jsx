    ...
    return <>
        <main className={montserrat.className}>
            <div className="bg-base-200 h-screen">
                ...
                <div className={isFullWidth ? 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute w-full top-40  left-1/2 transform -translate-x-1/2' : 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute max-w-7xl w-full top-40  left-1/2 transform -translate-x-1/2 mt-16 md:mt-0'}>
